...
// ===========================================
// HEADER (Full - for Collection Page)
// ===========================================
...
export function renderMinimalHeader(product = null) {
  ...
  const whatsappMessage = `Hi ${storeName}! 👋 I have a question about one of your products.`;
      ...
      <div class="minimal-header-content">
        ...
        <a href="#" class="minimal-header-logo" onclick="window.showCollection(); return false;" aria-label="Back to ${storeName}">
          ${heroPhotoUrl 
            ...
            : `<span class="minimal-logo-text">${logoText}</span>`
          }
        ...
        <div class="minimal-header-actions">
          ${cleanPhone ? `
            <a href="${whatsappLink}" target="_blank" class="minimal-action-btn whatsapp" aria-label="WhatsApp us">
            ...
            <a href="${callLink}" class="minimal-action-btn call" aria-label="Call us">
